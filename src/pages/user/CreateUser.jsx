...
const CreateUser = () => {
    ...
    return (
        <>
            {Object.keys(selectRoles).length === 0 && Object.keys(selectCenters).length === 0 ? <div>...Loading</div> : (
                <Formik
                    initialValues={{
                        firstName: "",
                        lastName: "",
                ...
                >
                    {({
                        ...
                        <>
                            <PageTitle title="Create user" button={
                            ...
                            <Box component="form" >
                                <Grid container spacing={2}  >
                                    ...
                                    <Grid item xs={6}>
                                        <FormControl fullWidth variant="standard" margin="dense" error={touched.gender && errors.gender}>
